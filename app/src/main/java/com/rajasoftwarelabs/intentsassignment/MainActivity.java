...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupEmailIntent() {
        // Initialise the different views fr0om the UI using findViewById.
        ...
        sendEmailButton.setOnClickListener(view -> {
            ...
            if (TextUtils.isEmpty(name)) {
                ...
                i.putExtra(Intent.EXTRA_EMAIL,name);
                i.putExtra(Intent.EXTRA_SUBJECT,"coffee");
                i.putExtra(Intent.EXTRA_TEXT,numCoffees);
